...
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {aPixelClkLckd_0}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {pLocked_0}]
...
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVCMOS33} [get_ports {ctrl}]
